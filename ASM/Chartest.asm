;E:\Programmierung\Delphi7\Projects\CubeOS\CubeOOP\Works\Projects\Chartest.OOP AT 20.08.2018 19:29:07
.486
locals
jumps
.model flat,STDCALL
...
Pop ESI ; Exit Call_Assignment
;
;s2 := '111111111111111111111111111111';
Push ESI ; Entry Call_Assignment 1
Push ESI ; Entry Call_Assignment 2
POP EBX ; LOAD Basepointer ESI
Push ESI ; Store LS
...
$_S2 db 30,30,'111111111111111111111111111111'
i dw 0
cha db 0
chb db 0
b db 0
